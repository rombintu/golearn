...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameAudit.setMaximumSize(QtCore.QSize(408, 16777215))
        ...
        self.lineTags.setReadOnly(True)
        ...
        self.pushGetMeCourse = QtWidgets.QPushButton(self.frame)
        self.pushGetMeCourse.setEnabled(False)
        self.pushGetMeCourse.setStyleSheet("")
        self.pushGetMeCourse.setFlat(True)
        self.pushGetMeCourse.setObjectName("pushGetMeCourse")
        self.gridLayout_2.addWidget(self.pushGetMeCourse, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.plainTextAboutCourse, 0, 1, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushGetMeCourse.setText(_translate("MainWindow", "В избранное"))
