...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listAudit = QtWidgets.QListView(self.frameAudit)
        self.listAudit.setObjectName("listAudit")
        self.verticalLayout.addWidget(self.listAudit)
        ...
        self.menupowered_by_Nickolsky.addAction(self.actionAudit)
